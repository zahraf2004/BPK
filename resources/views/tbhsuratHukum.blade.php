        ...
        <form action="/tbhsurathukum" method='POST' enctype="multipart/form-data">
            ...
            <div class="form1">
                <section id="step-1" class="form-step mr-9 ml-9">
                    <h4 class="card-title">{{ isset($surat_hukum) ? 'Edit Surat Hukum' : 'Input Surat Hukum' }}
                    </h4>
                    <br>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="namesurat" placeholder="nama surat"
                                        value="{{ old('namesurat', $surat_hukum->namesurat ?? '') }}" required />
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="Nomor" placeholder="nomor surat"
                                        value="{{ old('Nomor', $surat_hukum->Nomor ?? '') }}" required />
                                </div>
                            </div>
                            <div class="form-group row">
