    ...
    <div id="wrapper">
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <!-- Data FORM -->
                <form action="/tbhsuratKeuangan/update/{{$surat_keuangan->id}}" method='POST'
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="namesurat"
                                                ...
                                                value="{{ old('namesurat', $surat_keuangan->namesurat ?? '')}}"
                                                required />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="keterangan"
                                                ...
                                                value="{{ old('keterangan', $surat_keuangan->keterangan ?? '')}}"
                                                required />
                                        </div>
                                    </div>
                                    <div class="form-group row">
