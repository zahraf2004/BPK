    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Dashboard > Subbagian Keuangan > Form Input Surat</li>
            </ol>
        </div>

        <!-- Data FORM -->
        <form action="/tbhsuratKeuangan/update/{{$surat_keuangan->id}}" method='POST' enctype='multipart/form-data'>
            @csrf
            <div class="form1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="namesurat" placeholder="nama surat"
                                        value="{{ old('namesurat', $surat_keuangan->namesurat ?? '')}}" required />
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="Nomor" placeholder="nomor surat"
                                        value="{{ old( 'Nomor', $surat_keuangan->Nomor ?? '')}}" required />
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" name="tgl" placeholder="Masukkan tanggal"
                                        value="{{ old('tgl', $surat_keuangan->tgl ?? '')}}" required />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="keterangan"
                                        ...
                                        value="{{ old('keterangan', $surat_keuangan->keterangan ?? '')}}" required />
                                </div>
                            </div>
                            <div class="form-group row">
